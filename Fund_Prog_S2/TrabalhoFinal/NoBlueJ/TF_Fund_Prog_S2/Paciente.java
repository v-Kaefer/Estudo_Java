...
public class Paciente {
    ...
    public double setPeso() { // intervalo (0; 150kg] => ( p>0 && p<=150 ). OK
        System.out.println("Insira o valor do Peso do Paciente:");
    ...
    public double setAltura() { // intervalo (0; 2.5m] => ( a>0 && a<=2.5 ). OK
    ...
    public int setIdade() { // intervalo (0; 120] => ( i>0 && i<=120 ). OK
    ...
    public String toString() {
        return "{ Codigo: "+codigo+", Nome: "+nome+", Sexo: "+sexo+", Peso: "+peso+", Altura: "+altura+", Idade: "+idade;
    }
